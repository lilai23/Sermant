...
public class SpringBootRegistryEventCollector extends EventCollector {
    ...
    public void collectRegistryEvent(DefaultServiceInstance instance) {
        ...
        offerEvent(new Event(SpringBootRegistryEventDefinition.SPRING_BOOT_REGISTRY.getScope(),
                SpringBootRegistryEventDefinition.SPRING_BOOT_REGISTRY.getEventLevel(),
                SpringBootRegistryEventDefinition.SPRING_BOOT_REGISTRY.getEventType(),
                new EventInfo(SpringBootRegistryEventDefinition.SPRING_BOOT_REGISTRY.getName(), eventDescription)));
    }
    ...
    public void collectUnRegistryEvent(DefaultServiceInstance instance) {
        ...
        offerEvent(new Event(SpringBootRegistryEventDefinition.SPRING_BOOT_UNREGISTRY.getScope(),
                SpringBootRegistryEventDefinition.SPRING_BOOT_UNREGISTRY.getEventLevel(),
                SpringBootRegistryEventDefinition.SPRING_BOOT_UNREGISTRY.getEventType(),
                new EventInfo(SpringBootRegistryEventDefinition.SPRING_BOOT_UNREGISTRY.getName(), eventDescription)));
    }
    ...
    public void collectGrayConfigTakeEffectEvent(String config) {
        ...
        offerEvent(new Event(SpringBootRegistryEventDefinition.SPRING_BOOT_GRAY_CONFIG_TAKE_EFFECT.getScope(),
                SpringBootRegistryEventDefinition.SPRING_BOOT_GRAY_CONFIG_TAKE_EFFECT.getEventLevel(),
                SpringBootRegistryEventDefinition.SPRING_BOOT_GRAY_CONFIG_TAKE_EFFECT.getEventType(),
                new EventInfo(SpringBootRegistryEventDefinition.SPRING_BOOT_GRAY_CONFIG_TAKE_EFFECT.getName(),
                        eventDescription)));
    }
}
