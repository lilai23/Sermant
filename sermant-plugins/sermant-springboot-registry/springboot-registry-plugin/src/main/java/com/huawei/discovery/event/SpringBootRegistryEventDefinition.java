...
public enum SpringBootRegistryEventDefinition {
     ...
     * SpringBoot服务注册事件
     */
    SPRING_BOOT_REGISTRY("SPRING_BOOT_REGISTRY", EventType.GOVERNANCE, EventLevel.NORMAL),

    /**
     * SpringBoot注册插件灰度配置生效事件
     */
    SPRING_BOOT_GRAY_CONFIG_TAKE_EFFECT("SPRING_BOOT_GRAY_CONFIG_TAKE_EFFECT", EventType.GOVERNANCE, EventLevel.NORMAL),

    /**
     * SpringBoot服务移除注册事件
     */
    SPRING_BOOT_UNREGISTRY("SPRING_BOOT_UNREGISTRY", EventType.GOVERNANCE,
            EventLevel.NORMAL);
